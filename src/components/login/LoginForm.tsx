...
function LoginForm() {
  ...
  return (
	...
	<div className="">
	  <h2 className="text-[26px] font-bold py-[1vh]">Login</h2>
	  <p className="font-extralight text-[14px] md:text-[18px] text-[#787474 py-[1vh]">
		Log in to stay on top of your job applications, interviews, and progress all in one place.
	  </p>
	</div>
	<div className="font-[500] text-[16px] grid gap-1.5 pb-1 md:pb-4">
	...
	<div className="pt-[6vh] md:pb-[2vh]">
	  <button
		type="submit"
