...
//           className="flex flex-col sm:flex-row gap-2 w-[100%] sm:items-center sm:justify-center px-4">
//           <input
...
//           <button
//             type="submit"
//             className="px-[25px] bg-purple-700 rounded-xs text-white">
//             Search
//           </button>
...
//               <motion.div
//                 key={job.id}
//                 className="bg-gray-400 py-[2vh] px-[4%] rounded-2xl"
//                 initial={{ y: 0 }}
//                 whileHover={{ y: -10 }}
...
//                   </Link>
//                   <button
//                     className="bg-purple-700 text-white py-[5px] px-[16px] rounded-xl cursor-pointer"
